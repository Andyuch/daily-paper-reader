...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-22 20:41:20 UTC<br>状态：成功</p>
</section>
...
<p>今日精读2篇、速读4篇，聚焦同步辐射原位操控、界面光电子动力学及超快光学前沿。最值得看的两篇8分工作：多工具机器人实现同步辐射时间分辨原位样品操控，以及单层h-BN/金属界面波纹调控光激发电子动力学。建议优先精读机器人原位操控论文，其方法论对实验自动化有直接启发。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Multi-Tool Robotics Enables In-Situ Sample Manipulation for Time-Resolved Synchrotron Measurements">Multi-Tool Robotics Enables In-Situ Sample Manipulation for Time-Resolved Synchrotron Measurements</span></li><li><span class="dpr-home-dashboard-paper-title" title="Tuning of Photoexcited Electron Dynamics at Monolayer h-BN/Metal Interfaces by Corrugation">Tuning of Photoexcited Electron Dynamics at Monolayer h-BN/Metal Interfaces by Corrugation</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="From Photothermal Transients to Effective Transport Operators: An Operator-Based Interpretation of TTG Dynamics">From Photothermal Transients to Effective Transport Operators: An Operator-Based Interpretation of TTG Dynamics</span></li><li><span class="dpr-home-dashboard-paper-title" title="Burst-Driven Collective Ultrafast Interactions for Confined Optical Absorption">Burst-Driven Collective Ultrafast Interactions for Confined Optical Absorption</span></li><li><span class="dpr-home-dashboard-paper-title" title="Tracking Chirality during Molecular Motor Photoisomerization via Simulated Time-Resolved Circular Dichroism">Tracking Chirality during Molecular Motor Photoisomerization via Simulated Time-Resolved Circular Dichroism</span></li></ul>
  </div>
