...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-07-29 21:43:37 UTC<br>状态：成功</p>
</section>
...
<p>今日速读两篇论文，分别聚焦非线性显微镜下的极化子传输与MoSe2/MoS2异质结中堆叠极性调控的光载流子动力学。</p>
<p>最值得关注的是7分研究揭示了超快极化子传输的导引通道，以及6分工作阐明了堆叠极性对层间光载流子动力学的控制。</p>
<p>建议深入阅读极化子导引通道的机制，并关注异质结堆叠调控策略在光电器件中的应用潜力。</p>
  </div>
</section>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Full-wave nonlinear microscopy reveals guided channel for ultrafast polariton transport">Full-wave nonlinear microscopy reveals guided channel for ultrafast polariton transport</span></li><li><span class="dpr-home-dashboard-paper-title" title="Stacking Polarity-Controlled Interlayer Photocarrier Dynamics in MoSe2/MoS2 Heterostructures">Stacking Polarity-Controlled Interlayer Photocarrier Dynamics in MoSe2/MoS2 Heterostructures</span></li></ul>
  </div>
