...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-10 20:41:46 UTC<br>状态：成功</p>
</section>
...
<p>今日仅速读1篇论文，暂无精读内容。</p>
<p>最值得关注：电荷密度波材料中“亚晶格分辨的相干声子动力学”研究，揭示了声子与CDW的微观关联。</p>
<p>建议后续可围绕该方向补充精读，并结合相关实验综述加深理解。</p>
  </div>
</section>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Sublattice-resolved coherent phonon dynamics in charge density waves">Sublattice-resolved coherent phonon dynamics in charge density waves</span></li></ul>
  </div>
