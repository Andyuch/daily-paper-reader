...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-07-25 21:13:46 UTC<br>状态：成功</p>
</section>
...
<p>今日速读2篇论文，涵盖珠光体钢疲劳应变松弛与单层MoS₂气体传感。最值得关注的是珠光体钢应变松弛的Operando观察（7分），其次MoS₂多尺度蒙特卡洛模拟。建议优先精读首篇，深入理解金属疲劳微观机制，后续可对比二维材料传感模拟方法。</p>
  </div>
</section>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Operando observation of strain relaxation in fatigued pearlitic steel">Operando observation of strain relaxation in fatigued pearlitic steel</span></li><li><span class="dpr-home-dashboard-paper-title" title="Multiscale ensemble Monte Carlo of transport and gas sensing in monolayer MoS$_2$">Multiscale ensemble Monte Carlo of transport and gas sensing in monolayer MoS$_2$</span></li></ul>
  </div>
