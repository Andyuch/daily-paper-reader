...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-12 21:09:18 UTC<br>状态：成功</p>
</section>
...
<p>今日速读3篇论文，聚焦光学激发时间特性、超快电子自旋动力学及二维非晶膜动态。最值得关注的是《Revealing time characteristics of optical excitations...》（7.0/10），其阴极发光干涉测量法可揭示介电与等离子体结构的激发时间特征。后续可围绕该方向选取相关文献精读，或扩展至超快自旋动力学主题。</p>
  </div>
</section>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Revealing time characteristics of optical excitations in dielectric and plasmonic structures through cathodoluminescence interferometry">Revealing time characteristics of optical excitations in dielectric and plasmonic structures through cathodoluminescence interferometry</span></li><li><span class="dpr-home-dashboard-paper-title" title="Momentum-Selective Electron and Spin Dynamics under Ultrafast Photoexcitation">Momentum-Selective Electron and Spin Dynamics under Ultrafast Photoexcitation</span></li><li><span class="dpr-home-dashboard-paper-title" title="Dynamics of amorphous membranes in the two-dimensional limit">Dynamics of amorphous membranes in the two-dimensional limit</span></li></ul>
  </div>
